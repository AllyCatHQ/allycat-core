...
import { UI, MESSAGES, SCAN_MODES, STANDARDS, CLI, SUPPORTED_FRAMEWORKS, AI_REPORT_BEHAVIORS, CURRENT_CONFIG_VERSION, getStandardLabel } from '../constants.js';
            ...
            aiReportBehavior: ({ results }) => !results.useAI
                ...
                : p.select({
                    ...
                    options: [
                        ...
                        { value: AI_REPORT_BEHAVIORS.NEVER,     label: '🚫 Never generate',         hint: 'No file written — use allycat report to generate on demand' },
                    ],
                }),
